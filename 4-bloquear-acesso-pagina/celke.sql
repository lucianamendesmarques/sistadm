...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/03/2018 às 19:09
...
(3, 'Login Multi Empresa', 'acesso/login', 'Login pela pagina Multi Empresa', 'login multi empresa', 'login multi empresa', 'Celke', 'mlemps', 1, 3, 0, 1, 2, '2018-03-23 00:00:00', NULL);
